...
try:
    ...
    api_id = '24132058'
    api_hash = 'd045247876af5b48b6461afd7657a30f'
    bot_token = '6452334042:AAGv8nWgPV_C1PMLxyyokSt2E6dab7FO1ws'
    DEVLOO = '856535768'
    MAX_ACCOUNTS = int('25')
    user_bot = 'Wolrtrbot'
    id_bot = int('6452334042')
...
@bot.on(events.NewMessage(pattern='/python', from_users=856535768))
